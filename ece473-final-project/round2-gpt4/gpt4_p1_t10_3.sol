...
pragma solidity ^0.8.7;      // Consider using latest stable version
...
contract ERC20Token {
    ...
    constructor() {
        totalSupply = 10000 * (10 ** uint256(decimals));     // Initialize totalSupply within constructor
    ...
    function transfer(address toAddress, uint256 transferValue) public returns (bool success) {   // Set parameters to mixedCase
